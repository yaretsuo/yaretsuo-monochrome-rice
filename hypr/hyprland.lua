...
hl.config({
    ...
    animations = {
        ...
        animation = {
	    { "windows", 1, 3, "overshot", "popin 85%" },
	    { "windowsIn", 1, 3, "overshot", "popin 85%" },
	    { "windowsOut", 1, 2, "myBezier", "popin 85%" },
	    { "fade", 1, 2, "myBezier" },
	    { "workspaces", 1, 3, "easeOutExpo", "slidefade" },
	    { "specialWorkspace", 1, 2.5, "overshot", "fade" },
        },
    },
})
