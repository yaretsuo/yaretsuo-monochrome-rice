...
hl.config({
    ...
    animations = {
        ...
        bezier = {
			...
			{"bounce", 0.34, 1.3, 0.55, 1},
        },
        animation = {
	    {"windows", 1, 2.5, "smooth", "popin 80%"},
		{"windowsIn", 1, 2.5, "smooth", "popin 80%"},
		{"windowsOut", 1, 2.5, "smooth", "popin 80%"},
		{"fade", 1, 2, "smooth"},
		{"fadeIn", 1, 2, "smooth"},
		{"fadeOut", 1, 2, "smooth"},
		{"workspaces", 1, 2.5, "smooth", "slidefade"},
		{"specialWorkspace", 1, 2, "smooth", "fade"},
		{"resize", 0.5, 1, "smooth"},
		{"border", 0.5, 1, "smooth"},
        },
    },
